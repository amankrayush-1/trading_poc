"""
Bot Driver/Main Class for Level Trading Strategy
...
from bot.level_trading.config_reader import ConfigReader
from bot.utils import Utils
from bot.level_trading.strategy import LevelTradingStrategy
...
class BotDriver:
    ...
    def execute_strategy_for_account(self, account: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            strategy_instance = LevelTradingStrategy(
                groww=groww,
                utils=utils,
                config=account_config
            )

            print(f"[{account_name}] ✓ Level Trading Strategy loaded")
...
def main():
    ...
    """
    print("=" * 50)
    print("Level Trading Bot (Parallel Mode)")
    print("=" * 50)
